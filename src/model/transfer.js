...
module.exports.getAccountBalance =()=>{
    ...
    const sql_account_balance = ` SELECT  DISTINCT t.ACC_ID, a.ACC_NUMBER,  t.CUR_ID, c.CUR_NAME, t2.TYP_NAME, sum(t.TRN_AMOUNT) OVER (PARTITION BY t.ACC_ID, t.TYP_ID) "availableAmount"
